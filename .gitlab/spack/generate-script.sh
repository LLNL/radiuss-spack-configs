...
cp -rL .gitlab/spack/envs/shared-ci/spack_repos/llnl/radiuss/repo.yaml ${CI_PROJECT_DIR}/jobs_scratch_dir/concrete_environment/spack_repos/llnl/radiuss/repo.yaml
cp -rL .gitlab/spack/envs/shared-ci/spack_repos/llnl/radiuss/packages ${CI_PROJECT_DIR}/jobs_scratch_dir/concrete_environment/spack_repos/llnl/radiuss/packages
