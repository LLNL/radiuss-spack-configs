...
class Fmt(CMakePackage):
    ...
    patch(
        "fmt-no-variable-initialize_10.0.0.patch", when="@10.0.0:11.0.0%clang@12.0.1.ibm.gcc.8.3.1"
    )
    patch(
        "fmt-no-variable-initialize_10.0.0.patch", when="@10.0.0:11.0.0%clang@14.0.5.ibm.gcc.8.3.1"
    )
